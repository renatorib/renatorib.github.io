...
<SEO
  title="Tackling responsive elements in React and why I’ve created React Sizes."
  image={require("./images/cover.jpg")}
/>

<div style={{ maxWidth: "100%" }}>
  <img src={require("./images/cover.jpg")} style={{ maxWidth: "100%" }} />
</div>
...
Don’t forget to follow me on [twitter](http://twitter.com/renatorib_) and [github](http://github.com/renatorib).
